...
class VehicleCrash:
    ...
    PATH_TO_SAVED_MODEL = "C:\\Users\\sujan\\Desktop\\Final year project\\vehicle-crash-detector\\inference_graph\\saved_model"


    category_index = label_map_util.create_category_index_from_labelmap(r"C:\Users\sujan\Desktop\Final year project\vehicle-crash-detector\label_map.pbtxt", use_display_name=True)
