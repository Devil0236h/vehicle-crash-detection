...
class Email:
    ...
    def __init__(self,source):
        ...
        self.folder_path = "C:\\Users\\sujan\\Desktop\\Final year project\\vehicle-crash-detector\\outputs\\frame_img"
    ...
    def email_conn(self):
        ...
        self.smtp.login('sujanbangera888@gmail.com', 'ckyi wtfv uqby mrqn')
    ...
    def send_email(self,send_message,location,mail,vcd_reference_code):
        ...
        self.smtp.sendmail(from_addr="sujanbangera888@gamil.com ",
    ...
    def run_mail(self):
        rto_message = open('C:\\Users\\sujan\\Desktop\\Final year project\\vehicle-crash-detector\\messages\\rto_message.txt').read().strip()
        hospital_message = open('C:\\Users\\sujan\\Desktop\\Final year project\\vehicle-crash-detector\\messages\\hospital_message.txt').read().strip()
        police_message = open('C:\\Users\\sujan\\Desktop\\Final year project\\vehicle-crash-detector\\messages\\police_message.txt').read().strip()
        ...
        self.send_email(hospital_message, self.location, "rajeshanayak456@gmail.com",vcd_reference_code)
        self.send_email(police_message, self.location, "rajeshanayak456@gmail.com",vcd_reference_code)
        self.send_email(rto_message, self.location, "rajeshanayak456@gmail.com",vcd_reference_code)
        self.quit_conn()
