...
class VcdUI:
    def __init__(self,root):
        ...
        self.title_bar_icon = PhotoImage(file="C:/Users/sujan/Desktop/Final year project/vehicle-crash-detector/resources/icon/vehicle_crash_black.png")
        ...
        self.icon_white = Image.open("C:/Users/sujan/Desktop/Final year project/vehicle-crash-detector/resources/icon/vehicle_crash_white.png").resize((60, 60))
        self.icon_white = ImageTk.PhotoImage(self.icon_white)

        self.icon_black = Image.open("C:/Users/sujan/Desktop/Final year project/vehicle-crash-detector/resources/icon/vehicle_crash_black._32.png").resize((60, 60))
